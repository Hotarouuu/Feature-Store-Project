...
# O que colocamos nesse script depende do tipo de engenharia de atributos que queremos aplicar. Para este projeto, estamos criando apenas dados de exemplo para a construção da feature store. 