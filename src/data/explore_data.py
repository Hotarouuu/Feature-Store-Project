...
def plot_feature_distributions(df_features_dsa):
    ...
    plt.savefig('artifacts/plot_feature_distributions.png', dpi=300, bbox_inches='tight')
...
def plot_feature_correlations(df_features_dsa):
    ...
    plt.savefig('artifacts/plot_feature_correlations.png', dpi=300, bbox_inches='tight')
